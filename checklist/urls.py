...
urlpatterns = [
    ...
    path('<uuid:checklist_id>/item', views.ChecklistItem.as_view(), name='add-checklist-item'),
    path('item/<uuid:item_id>', views.ChecklistItem.as_view(), name='user-checklist-item'),
